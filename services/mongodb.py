...
class MongoDBManager:
    """MongoDB manager with hybrid search capabilities."""
    ...
    def _load_cluster_centroids(self) -> Dict[int, List[float]]:
        """Load cluster centroids for efficient search."""
    ...
    def _find_top_clusters(
        ...
        """Find top N clusters closest to query."""
    ...
    def _bm25_search(
        ...
        """Search using text matching (simplified BM25-like)."""
        # Extract keywords
